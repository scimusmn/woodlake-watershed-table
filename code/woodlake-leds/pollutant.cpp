...
void setupPollutants() {
  ...
  ADD_SEGMENT(PHOSPHORUS_PIPE_START, PHOSPHORUS_PIPE_END);
  ...
  ADD_MIRROR(SALT_FLOWB_START, SALT_FLOWB_END);
  ADD_SEGMENT(SALT_PIPE_START, SALT_PIPE_END);
  #undef POLLUTE
